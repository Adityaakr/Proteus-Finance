...
// BNB to USD conversion rate (approximate)
...
export function FXPayScreen({ balance = '0', walletAddress }: FXPayScreenProps) {
  ...
  // Calculate USD balance from BNB
  const bnbBalance = parseFloat(balance);
  const usdBalance = bnbBalance * BNB_TO_USD;
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.balanceCard}>
          ...
          <Text style={styles.bnbBalanceText}>
            {bnbBalance.toFixed(4)} BNB ≈ ${formattedUsdBalance} USD
          </Text>
        </View>
