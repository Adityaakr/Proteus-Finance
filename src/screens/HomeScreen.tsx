...
export const HomeScreen = ({ walletAddress, balance: balanceProp, onSendClick, onFXPayClick }: HomeScreenProps) => {
  ...
  const [bnbBalance, setBnbBalance] = useState<string>(balanceProp || '0');
  const [isLoadingBalance, setIsLoadingBalance] = useState(false);

  // Update balance when prop changes
  useEffect(() => {
    if (balanceProp !== undefined) {
      setBnbBalance(balanceProp);
  ...
  const balance = {
    total: parseFloat(bnbBalance) * 600, // Mock BNB to USD conversion
    available: parseFloat(bnbBalance) * 600,
    locked: 0,
    percentChange: 12.5,
  };
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        >
              ...
              {isLoadingBalance ? (
                ...
                <>
                  ...
                  <Text style={styles.balanceCurrency}>
                    ≈ ${balance.total.toLocaleString('en-US', { minimumFractionDigits: 2 })} USD
                  </Text>
                </>
              )}
            </View>
          ...
          <View style={styles.balanceBreakdown}>
            <View>
              ...
              <Text style={styles.breakdownValue}>aditya.bnb</Text>
            </View>
            <View>
              <Text style={styles.breakdownLabel}>Network</Text>
              <Text style={styles.breakdownValue}>BNB Testnet</Text>
            </View>
            <View>
            </View>
          </View>
      ...
      <Sheet
        ...
        title="Receive BNB"
        description="Send BNB on BNB Chain / BPN to this address"
      >
        <View style={styles.sheetContent}>
          ...
          <View style={styles.infoBox}>
            <Text style={styles.infoText}>
              💡 Only send BNB, USDT or FDUSD on BNB Chain. Other tokens may be lost.
            </Text>
          </View>
        </View>
      </Sheet>
      ...
      <Sheet
        ...
        title="Swap Tokens"
        description="Exchange tokens on BNB Chain"
      >
        <View style={styles.sheetContent}>
          <View style={styles.inputGroup}>
