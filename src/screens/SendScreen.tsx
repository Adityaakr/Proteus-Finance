    ...
    <View style={styles.container}>
      <View style={styles.header}>
        <View style={styles.headerContent}>
          ...
          <View>
            <Text style={styles.title}>Send BNB</Text>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.inputSection}>
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <Text style={styles.balanceLabel}>Balance: 1.01 BNB</Text>
          </View>
          <View style={styles.amountContainer}>
            ...
            />
            <Text style={styles.currencyLabel}>BNB</Text>
          </View>
        ...
        <View style={styles.summaryCard}>
          <View style={styles.summaryRow}>
            ...
            <View style={styles.networkBadge}>
              <Text style={styles.networkText}>BNB Testnet</Text>
            </View>
          </View>
          ...
          <View style={styles.summaryRow}>
            ...
            <Text style={styles.summaryValue}>~0.0001 BNB</Text>
          </View>
        </View>
        ...
        >
          {isSending ? (
            ...
            <>
              ...
              <Text style={styles.sendButtonText}>Send BNB</Text>
